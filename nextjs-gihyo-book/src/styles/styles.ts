...
function isSpaceThemeKeys(
    prop: any,
    theme: AppTheme) : prop is SpaceThemeKeys {
...
function isColorThemeKeys(
    prop: any,
    theme: AppTheme) : prop is ColorThemeKeys {
...
function isFontSizeThemeKeys(
    prop: any,
    theme: AppTheme) : prop is FontSizeThemeKeys {
...
function isLetterSpacingThemeKeys(
    prop: any,
    theme: AppTheme) : prop is LetterSpacingThemeKeys {
...
function isLineHeightThemeKeys(
    prop: any,
    theme: AppTheme) : prop is LineHeightThemeKeys {
